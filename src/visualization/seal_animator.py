...
class SealBehaviorAnimator:
    ...
    def create_animation(
        ...
        ax_map.set_extent([min_lon, max_lon, min_lat, max_lat], crs=ccrs.PlateCarree())  # pyrefly: ignore
        ...
        # Gridlines
        gl = ax_map.gridlines(draw_labels=True, linewidth=0.5, alpha=0.5, linestyle='--')  # pyrefly: ignore
