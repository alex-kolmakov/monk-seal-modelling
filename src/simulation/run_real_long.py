...
def run_long_simulation(
    duration_days=731, output_file="long_sim_results.csv", seed=None, num_agents=1
):
...
if __name__ == "__main__":
    ...
    run_long_simulation(
        duration_days=args.days, output_file=args.out, seed=args.seed, num_agents=args.agents
    )
