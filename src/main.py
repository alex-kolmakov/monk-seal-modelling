...
def main():
    ...
    parser.add_argument(
        "--action",
        choices=["list", "recommend", "download"],
        required=True,
    ...
    parser.add_argument(
        "--goal",
        type=str,
        choices=["physics", "biogeochemistry"],
        default="physics",
        help="Goal for recommendation",
    )
    parser.add_argument("--dataset_id", type=str, help="Dataset ID for download")
    parser.add_argument(
        "--output_dir", type=str, default="data", help="Output directory for download"
    )
    ...
    if args.action == "list":
        ...
        # ignore_term = "physics" if args.goal == "physics" else "biogeochemistry"
