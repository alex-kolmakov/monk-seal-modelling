...
def interactive_session():
    print(
        ">>> Agent: Hi! I can help you find Copernicus Marine datasets for your Monk Seal modeling."
    )
    print(
        ">>> Agent: Please tell me what you are looking for "
        "(e.g., 'model seal behavior in Madeira')."
    )
    ...
    while True:
        try:
            ...
            # 2. If user explicitly asks for "Global", we could add that,
            #    but let's start with IBI to keep it fast.
            ...
            # For comprehensive search, we might want to search for "Madeira"
            # specifically if IBI didn't return good stuff?
            ...
            print(
                "\n>>> Agent: Would you like to download any of these? "
                "(Type 'download ID' or ask another question)"
            )
