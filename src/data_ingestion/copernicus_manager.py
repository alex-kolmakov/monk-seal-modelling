...
class CopernicusManager:
    ...
    def validate_coordinates(
        ...
        RegionBounds(min_lon=min_lon, max_lon=max_lon, min_lat=min_lat, max_lat=max_lat)
    ...
    def validate_date_range(start_date: str, end_date: str) -> None:
        ...
        try:
            ...
            raise InvalidDateRangeError(f"Invalid date format. Use YYYY-MM-DD: {e}") from e
    ...
    def list_products(self, search_term: str | None = None) -> list[dict[str, Any]]:
        ...
        def _list() -> list[dict[str, Any]]:
            ...
            catalogue = copernicusmarine.describe(contains=contains, disable_progress_bar=True)
    ...
    def search_datasets(
        ...
        def _search() -> list[dict[str, Any]]:
            ...
            if hasattr(catalogue, "model_dump"):
                ...
                total_datasets = sum(len(p.get("datasets", [])) for p in products)
                current = 0
    ...
    def _check_region_overlap(self, coverage: dict[str, Any], region: RegionBounds) -> bool:
        ...
        lon_overlap = bbox["lon_min"] <= region.max_lon and bbox["lon_max"] >= region.min_lon
        lat_overlap = bbox["lat_min"] <= region.max_lat and bbox["lat_max"] >= region.min_lat
